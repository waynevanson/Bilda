...
use crate::runtime::{
    bilda_alloc_map, bilda_apply, bilda_capture_get, bilda_concat, bilda_decref, bilda_incref,
    bilda_list_push, bilda_make_bool, bilda_make_closure, bilda_make_float, bilda_make_int,
    bilda_make_list, bilda_make_string, bilda_make_unit, bilda_map_rename, bilda_map_set,
    bilda_print,
};
...
pub fn register_runtime_symbols(builder: &mut JITBuilder) {
    ...
    builder.symbol("bilda_make_unit", bilda_make_unit as *const u8);
    builder.symbol("bilda_make_string", bilda_make_string as *const u8);
    builder.symbol("bilda_concat", bilda_concat as *const u8);
    ...
    builder.symbol("bilda_make_list", bilda_make_list as *const u8);
    builder.symbol("bilda_list_push", bilda_list_push as *const u8);
    builder.symbol("bilda_make_closure", bilda_make_closure as *const u8);
    builder.symbol("bilda_capture_get", bilda_capture_get as *const u8);
